  ...
  <Container className="PrivacyPolicy Container">
    <Row>
      <Col xs={12}>
        ...
        <p>
          Labyrinths and Leviathans ("us", "we", or "our") operates the
        ...
        <p>
          Labyrinths and Leviathans uses the collected data for various
          purposes:
        </p>
        <ul>
        ...
        <p>
          Labyrinths and Leviathans will take all steps reasonably necessary to
        ...
        <p>
          Labyrinths and Leviathans may disclose your Personal Data in the good
          faith belief that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>
            To protect and defend the rights or property of Labyrinths and
            Leviathans
          </li>
          <li>
